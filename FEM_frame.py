    ...
    def gen_global_k(self):
        for i in range(len(self.elements)):
            if self.elements[i].type == 1:
                ...
                base = self.Tt_matrix[i].dot(self.local_k[i].dot(self.T_matrix[i]))
                globalk = np.zeros((12,12))
                globalk[0][0] += base[0][0]
                globalk[6][0] += base[6][0]
                globalk[0][6] += base[0][6]
                globalk[6][6] += base[6][6]
