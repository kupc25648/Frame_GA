...
class gen_model:
    def __init__(self,
                ...
                ,loadz
                ,Young
                ,c1,c2,c3,c4,c5,c6,c7,forgame=None,game_max_y_val=None,brace=None):
    ...
    def generate(self):
        ...
        if self.forgame ==0000:
            ...
            # 18 possibilities of form
            rand_val = random.random()*18
            #print('-------------------------------------------------------')
            #print('GENERATE GAME') #研究室
            #print('-------------------------------------------------------')
            # Initial node height equal to 0 / 最初のノードの高さは0です
    ...
    def render(self,name='',iteration=0,initenergy=0,recentenergy=0):
        ...
        for i in range(len(self.model.nodes)):
            ...
            if (self.model.nodes[i].res[0] == 1) and (self.model.nodes[i].res[1] == 1) and (self.model.nodes[i].res[2] == 1):
                ...
                pass
        if Xcoord_Zres1 != 0:
            Zres1 = {'X':Xcoord_ZresXresYres1, 'Y':Ycoord_ZresXresYres1, 'Z':Zcoord_ZresXresYres1}
        ...
        Structure_type2 = ''
        Model_code2 =     'Current Strain Energy : ' + str(round(recentenergy,3))
        # NODES
        Xcoord = []  #Horizontal
        Ycoord = []  #Vertical
        Zcoord = []  #Horizontal
        ...
        for i in range(len(self.model.nodes)):
            ...
            if (self.model.nodes[i].res[0] == 1) and (self.model.nodes[i].res[1] == 1) and (self.model.nodes[i].res[2] == 1):
                ...
                pass
        if Xcoord_Zres != 0:
            Zres = {'X':Xcoord_ZresXresYres, 'Y':Ycoord_ZresXresYres, 'Z':Zcoord_ZresXresYres}
...
model_X = gen_model(num_x,num_z,span,diameter,loadx,loady,loadz,Young,c1,c2,c3,c4,c5,c6,c7,forgame,game_max_y_val,brace)
